...
/**
 * Default implementation of {@link BackgroundProducer}, adds a gradient background to an image. The
 * gradient color is diagonal and made of Color From (top left) and Color To (bottom right).
 */
