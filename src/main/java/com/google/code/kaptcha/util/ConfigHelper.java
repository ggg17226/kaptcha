...
public class ConfigHelper {
    ...
    try {
      ...
      if (colorValues.length == 4) {
        ...
        throw new ConfigException(
            paramName, paramValue, "Color can only have 3 (RGB) or 4 (RGB with Alpha) values.");
      }
  ...
  public Object getClassInstance(
      String paramName, String paramValue, Object defaultInstance, Config config) {
    Object instance;
    if ("".equals(paramValue) || paramValue == null) {
   ...
   * @param defaultFonts defaultFonts
   * @return Fonts
   */
  ...
  public int getPositiveInt(String paramName, String paramValue, int defaultInt) {
    ...
    if ("".equals(paramValue) || paramValue == null) {
      ...
      try {
        ...
        if (intValue < 1) {
          throw new ConfigException(
              paramName, paramValue, "Value must be greater than or equals to 1.");
        }
      } catch (NumberFormatException nfe) {
        throw new ConfigException(paramName, paramValue, nfe);
      }
   ...
   * @param paramName paramName
   * @param paramValue paramValue
   * @param defaultChars defaultChars
   * @return Chars
   */
